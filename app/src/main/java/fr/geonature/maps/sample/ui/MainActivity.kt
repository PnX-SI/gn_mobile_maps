...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val granted = PermissionUtils.checkSelfPermissions(this,
        ...
        GlobalScope.launch(Dispatchers.Main) {
            ...
            if (appSettings?.mapSettings == null) {
                Toast.makeText(this@MainActivity,
                               getString(R.string.toast_settings_not_found,
                ...
                supportFragmentManager.beginTransaction()
                        .replace(android.R.id.content,
                                 MapFragment.newInstance(appSettings.mapSettings!!,
                                                         EditFeatureButton.EditMode.SINGLE).apply {
                                             ...
                                             getOverlays { overlay -> overlay is FeatureCollectionOverlay }.asSequence()
                                                     ...
                                                     .map {
                                                         pois.asSequence()
                                                                 .filterNotNull()
                                                                 .map { geoPoint ->
                                                                     val filter = ContainsFeaturesFilter(geoPoint,
                                                                                                         it.layerStyle,
