...
class FeatureCollectionOverlayTest {
    ...
    fun testApplyContainsFeatureFilter() {
        ...
        var containsFeaturesFilter = ContainsFeaturesFilter(GeoPoint(47.226171477212425,
                                                                     -1.554340124130249),
                                                            LayerStyleSettings(),
        ...
        containsFeaturesFilter = ContainsFeaturesFilter(GeoPoint(47.226171477212425,
                                                                 -1.5544822812080383),
                                                        LayerStyleSettings(),
                                                        LayerStyleSettings.Builder.newInstance().color(Color.RED).build())
        featureCollectionOverlay.apply(containsFeaturesFilter)
