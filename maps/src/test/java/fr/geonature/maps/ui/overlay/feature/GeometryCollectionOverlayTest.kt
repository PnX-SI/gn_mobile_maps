...
class GeometryCollectionOverlayTest {
    ...
    fun testCreateOverlayFromMultiPoint() {
        ...
        val geometryCollectionOverlay = GeometryCollectionOverlay().apply { setGeometry(multiPoints) }
    ...
    fun testCreateOverlayFromMultiLineString() {
        ...
        val geometryCollectionOverlay = GeometryCollectionOverlay().apply { setGeometry(multiLineString) }
    ...
    fun testCreateOverlayFromMultiPolygon() {
        ...
        val geometryCollectionOverlay = GeometryCollectionOverlay().apply { setGeometry(multiPolygon) }
    ...
    fun testCreateOverlayFromGeometryCollection() {
        ...
        val geometryCollectionOverlay = GeometryCollectionOverlay().apply { setGeometry(geometryCollection) }
